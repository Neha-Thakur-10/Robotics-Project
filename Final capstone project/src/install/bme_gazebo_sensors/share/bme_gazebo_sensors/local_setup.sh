...
: ${AMENT_CURRENT_PREFIX:="/home/neha/gitjazzy/src/install/bme_gazebo_sensors"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bme_gazebo_sensors/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bme_gazebo_sensors/environment/path.sh"
